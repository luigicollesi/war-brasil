...
import { tradeCardsPatchCommand } from "@/src/lib/server/game-card-redemption-patch-command-service";
...
export async function POST(
  ...
  try {
    ...
    const result = await tradeCardsPatchCommand(roomId, session, body, metadata);
